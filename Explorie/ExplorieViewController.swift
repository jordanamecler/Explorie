...
class ExplorieViewController:UIViewController, UIPageViewControllerDataSource
{
    ...
    var activeIndex = 0
    var fromMap = false
    var fromMyStories = false
    var fromLikedStories = false
    ...
    override func viewDidLoad()
    {
        ...
        tempArray = LibraryAPI.sharedInstance.getStories()
